...
from lib.prune_all import prune_wanda_outlier_structure_special,prune_wanda_outlier_structure,prune_sparsegpt_outlier,prune_wanda_outlier,prune_mag_outlier, prune_wanda,prune_magnitude,prune_sparsegpt, check_sparsity, find_layers, prune_mag_outlier_layer, prune_mag_outlier_layer_wei, prune_mag_outlier_layer_wei_lamda, prune_mag_outlier_layer_wei_lamda_old, prune_trend, prune_value_trend, prune_mario
...
########################################### for train
    ...
    ############################ owl   ############################
    ...
    elif args.prune_method == "magnitude_owl_layer_wei":

        prune_mag_outlier_layer_wei(args, model, tokenizer, device, prune_n=prune_n, prune_m=prune_m)

    elif args.prune_method == "mario":
        prune_mario(args, model, tokenizer, device, prune_n=prune_n, prune_m=prune_m)
        ...
        print(f"{args.prune_method} not exist this method")
        input()
