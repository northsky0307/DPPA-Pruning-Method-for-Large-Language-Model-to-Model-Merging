...
CUDA_VISIBLE_DEVICES=0 python -m evaluation.inference --model_dir /root/run/typeng/yczhu/RFT-LLaMA2-7B --temperature 0.0 --top_p 1.0 --output_file ./outputs/gsm8k/rft.jsonl --dev_set gsm8k  --prompt_type math-single 